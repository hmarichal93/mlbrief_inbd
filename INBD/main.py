...
def inference(args):
    ...
    for i,f in enumerate(imagefiles):
        ...
        try:
            output  = model.process_image(f, upscale_result=upscale, center_mask_path=args.center_mask_path, max_n=30)
...
if __name__ == '__main__':
    ...
    parser_train.add_argument('--transfer_learning', action="store_true", help='Transfer learning')
    parser_train.add_argument('--model_path',      type=str,   default= None,  help='Path to a pretrained model')
